...
| 7  | O documento identifica os requisitos de acessibilidade do aplicativo | Por lei, aplicativos devem cumprir os requisitos da "Legislação sobre acesibilidade ao software" e como eles vão ser obedicidos geralmente são mostrados em documento sobre o aplicativo, principalmente, se ele for do governo. Com isso, deve ter na análise documental como é a acessibilidade para usuários com necessidades especiais. | [LEGISLAÇÃO SOBRE ACESSIBILIDADE AO SOFTWARE](https://www.acessibilidade.net/software/legislacao_software.php)| [Captura de Tela ]|

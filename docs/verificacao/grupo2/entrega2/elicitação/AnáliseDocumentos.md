...
| 5  | Identifica as integrações necessárias com outros sistemas existentes? | Confirmar se a análise aborda a integração do aplicativo com sistemas internos dos Correios, como sistemas de rastreamento de pacotes, sistemas de gerenciamento de armazém, entre outros. | [Engenharia de Software Moderna – Tópico 3.3.1. Exemplo: MPV](https://engsoftmoderna.info/cap3.html) | [Captura de Tela do exemplo da do MPV]() |
| 7  | O documento identifica os requisitos de usabilidade e de acessibilidade do aplicativo | Confirmar se requisitos de usabilidade, como facilidade de navegação, intuitividade e acessibilidade para usuários com necessidades especiais, são considerados na análise. | [LEGISLAÇÃO SOBRE ACESSIBILIDADE AO SOFTWARE](https://www.acessibilidade.net/software/legislacao_software.php)| [Captura de Tela ]|

...
| 3  | As partes interessadas estão listadas e indicada de acordo com os seus papéis e responsabilidades? | Verificar se todas as partes interessadas estão indicadas sobre quem são no projeto, incluindo as principais e as secundárias e se elas estão enumeradas no documento. <br> <br> <li> Partes interessadas chave são aquelas que têm um papel crucial no projeto, como stakeholders principais ou usuários-chave, enquanto partes interessadas não chave podem ter um impacto menor ou mais indireto. |  [Livro: Engenharia de Requisitos - Software Orientado a Negócios - Páginas 221, 222 e 230](https://analisederequisitos.com.br/wp-content/uploads/2023/06/engenharia-de-requisitos-software-orientado-ao-negocio.pdf) | <li> [Captura de Tela das páginas 221 e 222](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/photo_4904589328043322965_y.jpg) <br> <br> <li> [Captura de Tela da página 230](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/photo_4904589328043322966_y.jpg) |
| 4  | A análise de documentos inclui uma lista das normas e dos regulamentações relevantes que o aplicativo deve seguir? | Verificar se o documento contém uma lista detalhada das normas legais, regulamentações governamentais e diretrizes internas dos Correios que afetam o desenvolvimento e a funcionalidade do aplicativo. | [Livro Engenharia de Software de Sommerville - Páginas 78 e 91](https://archive.org/details/sommerville-engenharia-de-software-10e/page/90/mode/2up?q=normas) | <li> [Captura de Tela das página 78](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/smorville1.png)  <br> <br> <li> [Captura de Tela das página 91](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/smorville2.png)|
| 5  | Identifica as integrações necessárias com outros sistemas existentes? | Confirmar se a análise aborda a integração do aplicativo com sistemas internos dos Correios, como sistemas de rastreamento de pacotes, sistemas de gerenciamento de armazém, entre outros. | [Livro Engenharia de Software de Sommerville - Página 32](https://archive.org/details/sommerville-engenharia-de-software-10e/page/90/mode/2up?q=normas)  | [Captura de Tela da página 32](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/tentaiva.png) |
| 7  | O documento identifica os requisitos de acessibilidade do aplicativo | Por lei, aplicativos devem cumprir os requisitos da "Legislação sobre acesibilidade ao software" e como eles vão ser obedicidos geralmente são mostrados em documento sobre o aplicativo, principalmente, se ele for do governo. Com isso, deve ter na análise documental como é a acessibilidade para usuários com necessidades especiais. | [LEGISLAÇÃO SOBRE ACESSIBILIDADE AO SOFTWARE](https://www.acessibilidade.net/software/legislacao_software.php)| <li> [Captura de Tela](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/acessibilidade.pn) |
| 9  | Há uma lista dos requisitos não funcionais determinados pelos stakeholders? | Verificar se a análise documental inclui os requisitos não funcionais declarados pelos stakeholders. |  [Engenharia de Software Moderna – Tópico 1.2.1. Engenharia de Requisitos e 1.2.7 Gerência de Projetos](https://engsoftmoderna.info/cap1.html) | <li> [Captura de Tela: Tópico 1.2.1](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/oi1.png) <br> <br> <li> [[Captura de Tela: Tópico 1.2.7](https://raw.githubusercontent.com/Requisitos-de-Software/2024.1-CarteiradeTrabalhoDigital/main/docs/ImagensDiagrama/imagensRastreabilidade/ANaliseDocumentos/oi2.png) |
...
|----|-------------------------|------------|
| 1  | O documento identifica as necessidades do aplicativo de acordo com o documento de sua criação/Manual? |  |
| 2  | As partes interessadas estão explicitamente listadas na análise do documento? | |
| 3  | Todas as partes interessadas, tanto chave quanto não chave, estão enumeradas? |  | 
| 4  | A análise de documentos inclui uma lista das normas e dos regulamentações relevantes que o aplicativo deve seguir? |  |
| 5  | Identifica as integrações necessárias com outros sistemas existentes? |   | 
| 7  | O documento identifica os requisitos de usabilidade e de acessibilidade do aplicativo | | 
| 8  | Os requisitos de desempenho e escalabilidade são considerados na análise de documentos? |  | 

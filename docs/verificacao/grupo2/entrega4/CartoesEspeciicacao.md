...
|-----|------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|------------------------------------|
| 1   | O cartão de especificação possui um número de identificação único?     | Verificar se cada cartão tem um número de identificação para facilitar a referência e rastreabilidade.            | [Volere -Modelo para Especificações de Requisitos Página 4](https://www.volere.org/wp-content/uploads/2018/12/template14_ptbra.pdf)        |

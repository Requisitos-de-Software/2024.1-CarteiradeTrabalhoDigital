...
Inicialmente, uma integrante será responsável por elaborar a lista de verificações, que servirá como base para a análise dos cenários do projeto. Em seguida, outro integrante da equipe ficará responsável por avaliar os cenários utilizando a lista de verificação elaborada. Durante a avaliação, os integrantes documentarão suas observações.

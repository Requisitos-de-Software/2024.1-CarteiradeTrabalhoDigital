...
Este documento visa organizar os integrantes do grupo no processo de verificação do [Grupo 3](https://requisitos-de-software.github.io/2024.1-Correios/) da disciplina de Requisitos de software, onde dividimos os responsáveis pela confecção das listas/checklists de verificação dos artefatos. Este processo visa a busca por erros e deslizes cometidos pelas equipes de desenvolvimento do projeto para a realização de futuras correções.
...
|Técnica Elicitação - Análise Documental |Larissa Stéfane|Iago Passaglia|
|Técnica Elicitação - Brainstorm| Breno Alexandre|Caio Mesquita|
|Técnica Elicitação - Observação| Luana Medeiros| Breno Alexandre|
...
Dentro do Artefato de Rich Picture foi realizada a seguinte divisão:
...
Dentro do artefato de Cenários foi feita a seguinte divisão:
...
Dentro do artefato de Casos de uso foi feita a seguinte divisão:
...
Dentro do artefato de Espeficicação suplementar foi feita a seguinte divisão:
...
Dentro do artefato de Backlog foi feita a seguinte divisão:
...
Dentro do artefato de Histórias de usuário foi feita a seguinte divisão:
...
Dentro do artefato de NFR FRamework foi feita a seguinte divisão:

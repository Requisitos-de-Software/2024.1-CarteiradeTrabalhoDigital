...
| 3  | Os léxicos do aplicativo foram construídos considerando a frequência de uso dos símbolos?    |  A priorização dos símbolos com base na frequência de uso durante a construção dos léxicos do aplicativo dos correios reflete a importância relativa de cada termo no contexto da aplicação.    | SAYÃO, Miriam; CARVALHO, Gustavo R. de. Construção do léxico de aplicações. ANAIS DO CONGRESSO DE ALFAL, 2017. Pág 9. |

...
| 13 | As informações sobre outras atividades que podem acontecer ao mesmo tempo estão incluídas? | Verificar se as informações sobre outras atividades que podem acontecer ao mesmo tempo que os episódios do cenário estão incluídas na descrição do cenário. | [Retraining: Requirements Engineering](https://retraining.inf.ufsc.br/guia/app/classificacoes/tecnicas-de-elicitacao-de-requisitos/entidades/tecnicas-de-elicitacao-de-requisitos-cenarios) |
